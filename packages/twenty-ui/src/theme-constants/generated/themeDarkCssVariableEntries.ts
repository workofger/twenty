...
export const THEME_DARK_CSS_VARIABLE_ENTRIES: [string, string][] = [
  ...
  ["--t-accent-primary", "color(display-p3 0.29 0.193 0)"],
  ["--t-accent-secondary", "color(display-p3 0.29 0.193 0)"],
  ["--t-accent-tertiary", "color(display-p3 0.178 0.128 0.049)"],
  ["--t-accent-quaternary", "color(display-p3 0.111 0.094 0.064)"],
  ["--t-accent-accent3570", "color(display-p3 0.535 0.399 0.189)"],
  ["--t-accent-accent4060", "color(display-p3 0.535 0.399 0.189)"],
  ["--t-accent-accent1", "color(display-p3 0.082 0.07 0.05)"],
  ["--t-accent-accent2", "color(display-p3 0.111 0.094 0.064)"],
  ["--t-accent-accent3", "color(display-p3 0.178 0.128 0.049)"],
  ["--t-accent-accent4", "color(display-p3 0.239 0.156 0)"],
  ["--t-accent-accent5", "color(display-p3 0.29 0.193 0)"],
  ["--t-accent-accent6", "color(display-p3 0.344 0.245 0.076)"],
  ["--t-accent-accent7", "color(display-p3 0.422 0.314 0.141)"],
  ["--t-accent-accent8", "color(display-p3 0.535 0.399 0.189)"],
  ["--t-accent-accent9", "color(display-p3 1 0.77 0.26)"],
  ["--t-accent-accent10", "color(display-p3 1 0.87 0.15)"],
  ["--t-accent-accent11", "color(display-p3 1 0.8 0.29)"],
  ["--t-accent-accent12", "color(display-p3 0.984 0.909 0.726)"],
  ...
  ["--t-background-invertedPrimary", "color(display-p3 0.922 0.922 0.922)"],
  ["--t-background-invertedSecondary", "color(display-p3 0.702 0.702 0.702)"],
  ...
  ["--t-background-transparent-blue", "#fc820032"],
  ["--t-background-transparent-orange", "#ff590039"],
  ["--t-background-transparent-success", "#11ff992d"],
  ["--t-background-overlayPrimary", "#000000b8"],
  ["--t-background-overlaySecondary", "#0000005c"],
  ["--t-background-overlayTertiary", "#0000005c"],
  ["--t-background-radialGradient", "radial-gradient(50% 62.62% at 50% 0%, color(display-p3 0.506 0.506 0.506) 0%, color(display-p3 0.482 0.482 0.482) 100%)"],
  ["--t-background-radialGradientHover", "radial-gradient(76.32% 95.59% at 50% 0%, color(display-p3 0.482 0.482 0.482) 0%, color(display-p3 0.702 0.702 0.702) 100%)"],
  ["--t-background-primaryInverted", "color(display-p3 0.922 0.922 0.922)"],
  ["--t-background-primaryInvertedHover", "color(display-p3 0.702 0.702 0.702)"],
  ...
  ["--t-border-color-secondaryInverted", "color(display-p3 0.702 0.702 0.702)"],
  ["--t-border-color-inverted", "color(display-p3 0.922 0.922 0.922)"],
  ["--t-border-color-danger", "color(display-p3 0.348 0.11 0.142)"],
  ["--t-border-color-blue", "color(display-p3 0.422 0.314 0.141)"],
  ["--t-border-color-transparentStrong", "color(display-p3 1 1 1 / 0.071)"],
  ...
  ["--t-boxShadow-color", "rgba(0,0,0,0.6)"],
  ["--t-boxShadow-light", "0px 2px 4px 0px rgba(0,0,0,0.04), 0px 0px 4px 0px rgba(0,0,0,0.08)"],
  ["--t-boxShadow-strong", "2px 4px 16px 0px rgba(0,0,0,0.16), 0px 2px 4px 0px rgba(0,0,0,0.08)"],
  ["--t-boxShadow-underline", "0px 1px 0px 0px rgba(0,0,0,0.32)"],
  ["--t-boxShadow-superHeavy", "2px 4px 16px 0px rgba(0,0,0,0.12), 0px 2px 4px 0px rgba(0,0,0,0.04)"],
  ...
  ["--t-font-color-extraLight", "color(display-p3 0.298 0.298 0.298)"],
  ...
  ["--t-snackBar-success-backgroundColor", "#11ff992d"],
  ["--t-snackBar-error-color", "color(display-p3 0.83 0.329 0.324)"],
  ["--t-snackBar-error-backgroundColor", "#ff173f2d"],
  ["--t-snackBar-warning-color", "color(display-p3 0.9 0.45 0.2)"],
  ["--t-snackBar-warning-backgroundColor", "#ff590039"],
  ["--t-snackBar-info-color", "color(display-p3 1 0.77 0.26)"],
  ["--t-snackBar-info-backgroundColor", "#fc820032"],
  ["--t-snackBar-default-color", "color(display-p3 0.922 0.922 0.922)"],
  ["--t-snackBar-default-backgroundColor", "color(display-p3 1 1 1 / 0.059)"],
  ...
  ["--t-tag-text-blue", "color(display-p3 1 0.8 0.29)"],
  ...
  ["--t-tag-background-blue", "color(display-p3 0.178 0.128 0.049)"],
  ...
  ["--t-IllustrationIcon-color-blue", "color(display-p3 1 0.87 0.15)"],
  ["--t-IllustrationIcon-color-gray", "color(display-p3 0.4 0.4 0.4)"],
  ["--t-IllustrationIcon-fill-blue", "color(display-p3 0.984 0.909 0.726)"],
  ["--t-IllustrationIcon-fill-gray", "color(display-p3 0.133 0.133 0.133)"],
  ["--t-grayScale-gray1", "color(display-p3 0.09 0.09 0.09)"],
  ["--t-grayScale-gray2", "color(display-p3 0.106 0.106 0.106)"],
  ["--t-grayScale-gray3", "color(display-p3 0.098 0.098 0.098)"],
  ["--t-grayScale-gray4", "color(display-p3 0.114 0.114 0.114)"],
  ["--t-grayScale-gray5", "color(display-p3 0.133 0.133 0.133)"],
  ["--t-grayScale-gray6", "color(display-p3 0.282 0.282 0.282)"],
  ["--t-grayScale-gray7", "color(display-p3 0.298 0.298 0.298)"],
  ["--t-grayScale-gray8", "color(display-p3 0.4 0.4 0.4)"],
  ["--t-grayScale-gray9", "color(display-p3 0.506 0.506 0.506)"],
  ["--t-grayScale-gray10", "color(display-p3 0.482 0.482 0.482)"],
  ["--t-grayScale-gray11", "color(display-p3 0.702 0.702 0.702)"],
  ["--t-grayScale-gray12", "color(display-p3 0.922 0.922 0.922)"],
  ...
  ["--t-color-blue1", "color(display-p3 0.082 0.07 0.05)"],
  ["--t-color-blue2", "color(display-p3 0.111 0.094 0.064)"],
  ["--t-color-blue3", "color(display-p3 0.178 0.128 0.049)"],
  ["--t-color-blue4", "color(display-p3 0.239 0.156 0)"],
  ["--t-color-blue5", "color(display-p3 0.29 0.193 0)"],
  ["--t-color-blue6", "color(display-p3 0.344 0.245 0.076)"],
  ["--t-color-blue7", "color(display-p3 0.422 0.314 0.141)"],
  ["--t-color-blue8", "color(display-p3 0.535 0.399 0.189)"],
  ["--t-color-blue9", "color(display-p3 1 0.77 0.26)"],
  ["--t-color-blue10", "color(display-p3 1 0.87 0.15)"],
  ["--t-color-blue11", "color(display-p3 1 0.8 0.29)"],
  ["--t-color-blue12", "color(display-p3 0.984 0.909 0.726)"],
  ...
  ["--t-color-transparent-blue1", "#e63c0006"],
  ["--t-color-transparent-blue2", "#fd9b000d"],
  ["--t-color-transparent-blue3", "#fa820022"],
  ["--t-color-transparent-blue4", "#fc820032"],
  ["--t-color-transparent-blue5", "#fd8b0041"],
  ["--t-color-transparent-blue6", "#fd9b0051"],
  ["--t-color-transparent-blue7", "#ffab2567"],
  ["--t-color-transparent-blue8", "#ffae3587"],
  ["--t-color-transparent-blue9", "#ffc53d"],
  ["--t-color-transparent-blue10", "#ffd60a"],
  ["--t-color-transparent-blue11", "#ffca16"],
  ["--t-color-transparent-blue12", "#ffe7b3"],

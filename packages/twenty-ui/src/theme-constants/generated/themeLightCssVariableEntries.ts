...
export const THEME_LIGHT_CSS_VARIABLE_ENTRIES: [string, string][] = [
  ...
  ["--t-text-lineHeight-lg", "1.5"],
  ["--t-text-lineHeight-md", "1.1"],
  ["--t-text-iconSizeMedium", "16"],
  ["--t-text-iconSizeSmall", "14"],
  ["--t-text-iconStrikeLight", "1.6"],
  ["--t-text-iconStrikeMedium", "2"],
  ["--t-text-iconStrikeBold", "2.5"],
  ...
  ["--t-spacingMultiplicator", "4"],
  ["--t-betweenSiblingsGap", "2px"],
  ["--t-table-horizontalCellMargin", "8px"],
  ["--t-table-checkboxColumnWidth", "32px"],
  ["--t-table-horizontalCellPadding", "8px"],
  ["--t-rightDrawerWidth", "500px"],
  ["--t-clickableElementBackgroundTransition", "background 0.1s ease"],
  ["--t-lastLayerZIndex", "2147483647"],
  ["--t-buttons-secondaryTextColor", "color(display-p3 1 0.8 0.29)"],
  ["--t-accent-primary", "color(display-p3 0.97 0.902 0.527)"],
  ["--t-accent-secondary", "color(display-p3 0.97 0.902 0.527)"],
  ["--t-accent-tertiary", "color(display-p3 0.994 0.969 0.782)"],
  ["--t-accent-quaternary", "color(display-p3 0.994 0.986 0.921)"],
  ["--t-accent-accent3570", "color(display-p3 0.85 0.65 0.3)"],
  ["--t-accent-accent4060", "color(display-p3 0.85 0.65 0.3)"],
  ["--t-accent-accent1", "color(display-p3 0.995 0.992 0.985)"],
  ["--t-accent-accent2", "color(display-p3 0.994 0.986 0.921)"],
  ["--t-accent-accent3", "color(display-p3 0.994 0.969 0.782)"],
  ["--t-accent-accent4", "color(display-p3 0.989 0.937 0.65)"],
  ["--t-accent-accent5", "color(display-p3 0.97 0.902 0.527)"],
  ["--t-accent-accent6", "color(display-p3 0.936 0.844 0.506)"],
  ["--t-accent-accent7", "color(display-p3 0.89 0.762 0.443)"],
  ["--t-accent-accent8", "color(display-p3 0.85 0.65 0.3)"],
  ["--t-accent-accent9", "color(display-p3 1 0.77 0.26)"],
  ["--t-accent-accent10", "color(display-p3 0.959 0.741 0.274)"],
  ["--t-accent-accent11", "color(display-p3 0.64 0.4 0)"],
  ["--t-accent-accent12", "color(display-p3 0.294 0.208 0.145)"],
  ...
  ["--t-background-invertedPrimary", "color(display-p3 0.2 0.2 0.2)"],
  ["--t-background-invertedSecondary", "color(display-p3 0.4 0.4 0.4)"],
  ...
  ["--t-background-transparent-blue", "#ffde003d"],
  ["--t-background-transparent-orange", "#ff9c0029"],
  ["--t-background-transparent-success", "#00a43319"],
  ["--t-background-overlayPrimary", "color(display-p3 0 0 0 / 0.722)"],
  ["--t-background-overlaySecondary", "color(display-p3 0 0 0 / 0.361)"],
  ["--t-background-overlayTertiary", "color(display-p3 0 0 0 / 0.071)"],
  ["--t-background-radialGradient", "radial-gradient(50% 62.62% at 50% 0%, color(display-p3 0.6 0.6 0.6) 0%, color(display-p3 0.514 0.514 0.514) 100%)"],
  ["--t-background-radialGradientHover", "radial-gradient(76.32% 95.59% at 50% 0%, color(display-p3 0.514 0.514 0.514) 0%, color(display-p3 0.4 0.4 0.4) 100%)"],
  ["--t-background-primaryInverted", "color(display-p3 0.2 0.2 0.2)"],
  ["--t-background-primaryInvertedHover", "color(display-p3 0.4 0.4 0.4)"],
  ...
  ["--t-border-color-secondaryInverted", "color(display-p3 0.4 0.4 0.4)"],
  ["--t-border-color-inverted", "color(display-p3 0.2 0.2 0.2)"],
  ["--t-border-color-danger", "color(display-p3 0.984 0.812 0.811)"],
  ["--t-border-color-blue", "color(display-p3 0.89 0.762 0.443)"],
  ["--t-border-color-transparentStrong", "color(display-p3 0 0 0 / 0.071)"],
  ...
  ["--t-boxShadow-color", "color(display-p3 0 0 0 / 0.039)"],
  ["--t-boxShadow-light", "0px 2px 4px 0px color(display-p3 0 0 0 / 0.039), 0px 0px 4px 0px color(display-p3 0 0 0 / 0.078)"],
  ["--t-boxShadow-strong", "2px 4px 16px 0px color(display-p3 0 0 0 / 0.161), 0px 2px 4px 0px color(display-p3 0 0 0 / 0.078)"],
  ["--t-boxShadow-underline", "0px 1px 0px 0px color(display-p3 0 0 0 / 0.361)"],
  ["--t-boxShadow-superHeavy", "0px 0px 8px 0px color(display-p3 0 0 0 / 0.161), 0px 8px 64px -16px color(display-p3 0 0 0 / 0.478), 0px 24px 56px -16px color(display-p3 0 0 0 / 0.078)"],
  ...
  ["--t-font-color-extraLight", "color(display-p3 0.8 0.8 0.8)"],
  ...
  ["--t-name", "light"],
  ["--t-snackBar-success-color", "color(display-p3 0.297 0.637 0.581)"],
  ["--t-snackBar-success-backgroundColor", "#00a43319"],
  ["--t-snackBar-error-color", "color(display-p3 0.83 0.329 0.324)"],
  ["--t-snackBar-error-backgroundColor", "#f3000d14"],
  ["--t-snackBar-warning-color", "color(display-p3 0.9 0.45 0.2)"],
  ["--t-snackBar-warning-backgroundColor", "#ff9c0029"],
  ["--t-snackBar-info-color", "color(display-p3 1 0.77 0.26)"],
  ["--t-snackBar-info-backgroundColor", "#ffde003d"],
  ["--t-snackBar-default-color", "color(display-p3 0.2 0.2 0.2)"],
  ["--t-snackBar-default-backgroundColor", "color(display-p3 0 0 0 / 0.039)"],
  ...
  ["--t-tag-text-blue", "color(display-p3 0.64 0.4 0)"],
  ...
  ["--t-tag-background-blue", "color(display-p3 0.994 0.969 0.782)"],
  ...
  ["--t-IllustrationIcon-color-blue", "color(display-p3 0.85 0.65 0.3)"],
  ["--t-IllustrationIcon-color-gray", "color(display-p3 0.6 0.6 0.6)"],
  ["--t-IllustrationIcon-fill-blue", "color(display-p3 0.97 0.902 0.527)"],
  ["--t-IllustrationIcon-fill-gray", "color(display-p3 0.922 0.922 0.922)"],
  ["--t-grayScale-gray1", "color(display-p3 1 1 1)"],
  ["--t-grayScale-gray2", "color(display-p3 0.988 0.988 0.988)"],
  ["--t-grayScale-gray3", "color(display-p3 0.976 0.976 0.976)"],
  ["--t-grayScale-gray4", "color(display-p3 0.945 0.945 0.945)"],
  ["--t-grayScale-gray5", "color(display-p3 0.922 0.922 0.922)"],
  ["--t-grayScale-gray6", "color(display-p3 0.839 0.839 0.839)"],
  ["--t-grayScale-gray7", "color(display-p3 0.8 0.8 0.8)"],
  ["--t-grayScale-gray8", "color(display-p3 0.702 0.702 0.702)"],
  ["--t-grayScale-gray9", "color(display-p3 0.6 0.6 0.6)"],
  ["--t-grayScale-gray10", "color(display-p3 0.514 0.514 0.514)"],
  ["--t-grayScale-gray11", "color(display-p3 0.4 0.4 0.4)"],
  ["--t-grayScale-gray12", "color(display-p3 0.2 0.2 0.2)"],
  ...
  ["--t-color-blue", "color(display-p3 1 0.77 0.26)"],
  ...
  ["--t-color-blue1", "color(display-p3 0.995 0.992 0.985)"],
  ["--t-color-blue2", "color(display-p3 0.994 0.986 0.921)"],
  ["--t-color-blue3", "color(display-p3 0.994 0.969 0.782)"],
  ["--t-color-blue4", "color(display-p3 0.989 0.937 0.65)"],
  ["--t-color-blue5", "color(display-p3 0.97 0.902 0.527)"],
  ["--t-color-blue6", "color(display-p3 0.936 0.844 0.506)"],
  ["--t-color-blue7", "color(display-p3 0.89 0.762 0.443)"],
  ["--t-color-blue8", "color(display-p3 0.85 0.65 0.3)"],
  ["--t-color-blue9", "color(display-p3 1 0.77 0.26)"],
  ["--t-color-blue10", "color(display-p3 0.959 0.741 0.274)"],
  ["--t-color-blue11", "color(display-p3 0.64 0.4 0)"],
  ["--t-color-blue12", "color(display-p3 0.294 0.208 0.145)"],
  ...
  ["--t-color-transparent-blue1", "#c0800004"],
  ["--t-color-transparent-blue2", "#f4d10016"],
  ["--t-color-transparent-blue3", "#ffde003d"],
  ["--t-color-transparent-blue4", "#ffd40063"],
  ["--t-color-transparent-blue5", "#f8cf0088"],
  ["--t-color-transparent-blue6", "#eab5008c"],
  ["--t-color-transparent-blue7", "#dc9b009d"],
  ["--t-color-transparent-blue8", "#da8a00c9"],
  ["--t-color-transparent-blue9", "#ffb300c2"],
  ["--t-color-transparent-blue10", "#ffb300e7"],
  ["--t-color-transparent-blue11", "#ab6400"],
  ["--t-color-transparent-blue12", "#341500dd"],
